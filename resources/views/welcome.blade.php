                ...
                <div class="row py">
                    <div class="col-md">
                        {{--<input id="login" type="text"--}}
                               {{--class="form-control{{ $errors->has('phonenumber') || $errors->has('email') ? ' is-invalid' : '' }}"--}}
                               {{--name="login" value="{{ old('phonenumber') ?: old('email') }}" required placeholder="Email or phone" autofocus>--}}

                        {{--@if ($errors->has('phonenumber') || $errors->has('email'))--}}
                            {{--<span class="invalid-feedback">--}}
                {{--<strong>{{ $errors->first('phonenumber') ?: $errors->first('email') }}</strong>--}}
            {{--</span>--}}
                        {{--@endif--}}
                        <x-input id="login"
                ...
                <div class="block">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="remember">
                        <span class="ml-2 text-sm text-gray-600" style="color: #800000">{{ __('Remember me') }}</span>
                    </label>
                </div>
                <!-- End Remember Me -->
                ...
                <div class="d-flex pt-3">
                    <div class="ml-auto mr-auto">
                        <p style="color: #800000" >Already registered?</p>
                        <a  href="{{ route('test') }}" class="btn btn-info"  >Register</a>
                    </div>
                </div>
        </div>
</form>
